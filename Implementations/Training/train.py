...
if __name__ == "__main__":
    ...
    # Dataset parameters
    parser.add_argument('--baseroot', type = str, default = "/content/drive/MyDrive/Colab Notebooks/DeepFillv2 Training/dataset", help = 'the training folder')
    parser.add_argument('--pretrained_model_path', type=str, default='/content/drive/MyDrive/Colab Notebooks/DeepFillv2 Training/pretrained_model/deepfillv2_WGAN_G_epoch40_batchsize4.pth', help='Path to pretrained model (optional).')
